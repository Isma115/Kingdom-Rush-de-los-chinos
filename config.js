...
const maps = [
   ...
   { name: "Herradura", 
points: [{ x: 0, y: 400 }, { x: 150, y: 360 }, { x: 300, y: 300 }, { x: 450, y: 250 }, { x: 600, y: 200 }, { x: 1650, y: 400 }] },
...
AÑADIDOS === */
...

   {
      ...
      points: [
         ...
         { x: 800, y: 50 }, { x: 800, y: 450 }, { x: 1200, y: 
450 },
...

   {
      name: "Río",
      points: [
         { x: 0, y: 300 }, { x: 150, y: 280 }, { x: 300, y: 260 }, { x: 420, y: 320 }, 
{ x: 520, y: 380 }, { x: 1250, y: 250 },
...

   {
      ...
      points: [
         ...
         { x: 
750, y: 450 }, { x: 1000, y: 50 }, { x: 1250, y: 450 },
...
const enemyRoster = [
   ...
   { id: 3, name: "Lobo", color: "#00bfa5", hp: 55, 
speed: 1.3, reward: 11, size: 10, label: "🐺", damage: 12 },
   ...
   { id: 7, name: "Chamán", color: 
"#aa00ff", hp: 200, speed: 0.5, reward: 25, size: 14, label: "🔮", damage: 30 },
   ...
   { id: 11, name: "Asesino", color: "#ffd600", hp: 350, speed: 1.4, reward: 50, size: 10, label: "🗡️", damage: 
60 },
   ...
   { id: 16, name: "Dragón", color: "#37474f", hp: 
3000, speed: 0.33, reward: 150, size: 24, label: "🐉", damage: 150 },
   ...
   { id: 20, name: "Bruja", color: "#9c27b0", hp: 15000, speed: 0.5, reward: 400, size: 16, label: "🧙‍♀️", damage: 
180 },
   ...
   { id: 24, name: "Xilófago", color: "#795548", hp: 30000, speed: 0.33, reward: 1100, size: 20, label: "🪲", damage: 
260 },
  ...
  // === NUEVOS JEFES ===
   ...
   { id: 28, name: "JEFE: Titán del Abismo", color: "#000000", hp: 60000, speed: 0.12, reward: 5000, size: 45, label: "🌑", isBoss: true, damage: 
500 },
   { id: 29, name: "JEFE: Dios del Caos", color: "#7b1fa2", hp: 100000, speed: 0.18, reward: 8000, size: 50, label: "💀", isBoss: true, damage: 800 }
];
const towerTypes = { // Modificación: Añadido 'unlockWave' para desbloqueo progresivo
   archer: { cost: 70, range: 140, damage: 15, fireRate: 17.5, color: '#fdd835', type: 'combat', label: '🏹', projSpeed: 6, unlockWave: 1 },
   mine: { cost: 100, range: 0, damage: 15, fireRate: 90, color: '#8d6e63', type: 'combat', label: '🕳️', projSpeed: 0, unlockWave: 1 },
   cannon: { cost: 150, range: 110, damage: 60, fireRate: 45, color: '#424242', type: 'combat', label: '💣', projSpeed: 8, unlockWave: 4 },
   
   sniper: { 
cost: 300, range: 350, damage: 120, fireRate: 150, color: '#3f51b5', type: 'combat', label: '🎯', projSpeed: 10, chargeTime: 18, unlockWave: 12 },
   ice: { cost: 200, range: 100, damage: 5, fireRate: 60, color: '#00bcd4', type: 'support', label: '🧊', projSpeed: 4, unlockWave: 8 },
   mage: { cost: 400, range: 150, damage: 20, fireRate: 30, color: '#9c27b0', type: 'combat', label: '🔮', projSpeed: 5, chargeTime: 18, unlockWave: 15 },
   infernal: { cost: 600, range: 120, damage: 25, fireRate: 1, color: '#ff5722', type: 'combat', label: '🔥', projSpeed: 0, unlockWave: 20 } // Proyectil inexistente, usa láser
};
